...
const generarReporte = () => {
    ...
    const url = route("reportes.r_cadena_custodias", form.value);
...
<template>
    <Head title="Reporte Cadena de Custodia"></Head>
    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Reportes > Cadena de Custodia</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Reportes > Cadena de Custodia</h1>
    <!-- END page-header -->
    <div class="row">
